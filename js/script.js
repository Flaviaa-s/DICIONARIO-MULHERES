function carregaDicionario() {
  ...
  for (var bio in biografias) {
    content.innerHTML += '<div class="card">' + '<img src="' + biografias[bio].img + '"/>' + "<details>" + 
    "<summary>" + biografias[bio].nome +  "</summary>" + "<p>" + biografias[bio].descricao + "</p>" + "<blockquote><q>" + biografias[bio].citacao +
    ...
    */
   /* For vai percorrer todas as informações, por isso dentro da variável foi feito atribuição com o +=.
    A minha variavél tem um conjunto de objetos, por isso para acessar as informações referente ao objeto será feito
   assim biografias[bio] (para nome ou descrição) para pegar todas as informações.
    */
  };
}
